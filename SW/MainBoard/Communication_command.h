/**
   ...
   @brief prikazy pre komunikaciu, a nastavenie komunikacie
...
#define DEBUG_COMMUNICATION                       false      ///< enable/disable debug console

#define COMMUNICATION_BUFFER_SIZE                 25        ///< buffer size for frame
#define COMMUNICATION_COMMAND_LEN                 15        ///< buffer size for command

#define COMMUNICATIONT_TIMMEOUT                   300       ///< message timeout
#define COMMUNICATIONT_ACK_TIMMEOUT               300       ///< ack response timeout
